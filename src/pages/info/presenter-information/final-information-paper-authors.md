...
- For full papers, the abstract and index term sections use an em-dash between the heading and content; **there should not be a space** on either side of the em-dash and the content begins on the same line as the heading (in LaTeX, start your abstract directly after the `\abstract{` call).
