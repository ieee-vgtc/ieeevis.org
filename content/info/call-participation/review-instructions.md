...
8. For bidding, you will see four options for each submission: want, willing, reluctant, and conflict. The conflicted papers should be pre-selected as conflicts, based on steps 4-5 above: these papers will show "author conflict" instead of the radio buttons. 
...
Consider the mix of expertise and experience across all four reviewers, including varied career stages, gender diversity, practitioners and researchers, industry and academia, etc. We aim for a good mix of perspectives.
