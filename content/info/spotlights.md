...
### Summary
The energy sector faces many deep uncertainties about the future, including climate change, growth in energy demand and technologic capabilities, and cybersecurity. Deep uncertainty is characterized by a level of uncertainty where we do not know how to model a system or how to value the desirability of outcomes. Methodologies exist to evaluate the level of deep of uncertainty in a problem, and to help reason on risk and decisions; however, traditional making and visualization techniques may not be applicable when facing deeply uncertain problems. In this application spotlight, we will give an introduction to deep uncertainty including characterization of levels of deep uncertainty and how to approach unknowns to a problem. We will highlight the challenges of visualizing and decision making with deep uncertainty, and potential solutions to ensure it is properly captured and communicated to decisionmakers and stakeholders. We propose an overview of deep uncertainty and the unique challenges it poses, the need for decision making under deep uncertainty (DMDU) methodologies, and challenges in creating visualizations that capture such a wide range of uncertainty. We will follow with several lighting talk topics, including a use case applying DMDU methods to a campus energy resilience planning problem utilizing quantitative modeling, and a discussion of visualization methods that are best suited to capturing deep uncertainty. We will bring in deep uncertainty experts from Rand, as well as highlight work currently happening at NREL on both decision making and visualization. We will finish with a 30 guided discussion, with the goal of encouraging audience participation.
