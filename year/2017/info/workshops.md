...
## <a name="vis-dh"></a> 2nd Workshop on Visualization for the Digital Humanities
...
## <a name="interpretable-dl"></a> Visual Analytics for Interpretable, User-Driven Deep Learning
