...
function finishCalendar(renderPromises) {
  ...
  setTimeout(() => {
    ...
    // };
    const tzDayOfWeek = moment.tz(moment(), "Europe/Vienna").format('dddd')
    const tzTime = moment.tz(moment(), "Europe/Vienna").format('HHMM')
    const tzTimeStr = moment.tz(moment(), "Europe/Vienna").format('HH:MM')
    const tzDate = moment.tz(moment(), "Europe/Vienna").format('ddd, MMM DD')
